...
// import { SelectedItemsProvider, SelectedItemsContext } from "../../contexts/SelectedItemsContext";
        ...
        <div className="flex flex-col items-center">
              ...
              <>
                ...
                <div className="flex space-x-2 justify-center mt-5">
                  <button
                    ...
                    className="border-2 border-slate-50 rounded-lg p-1 text-slate-50 hover:bg-violet-500 transition-colors"
                  >
                    Select All
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="border-2 border-red-500 rounded-lg p-1 text-red-500 hover:bg-red-500 hover:text-white transition-colors"
                  >
                    Delete Selected
                  </button>
                </div>
          ...
          <div className="flex justify-between w-96 mt-2">
            ...
            <button
              ...
              } bg-green-500 px-3 py-1 rounded-lg font-medium text-white hover:bg-green-600 transition-colors`}
              disabled={count === 0}
              onClick={handleDone}
            >
              Done
